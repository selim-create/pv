...
class Birbot extends BirbotHelper
{
        ...
        <div class="bib-list">
            <form id="bibCronForm" action="javascript:;" method="post">
                <label>Kaynak Kategori</label><select name="category" class="bib-input cronCat">
                    <option value="https://www.sozcu.com.tr/kategori/dunya/">Dünya</option>
                    <option value="https://www.sozcu.com.tr/kategori/gundem/">Gündem</option>
                    <option value="https://www.sozcu.com.tr/kategori/ekonomi/">Ekonomi</option>
                    <option value="https://www.sozcu.com.tr/kategori/teknoloji/">Teknoloji</option>
                    <option value="https://www.sozcu.com.tr/kategori/egitim/">Eğitim</option>
                    <option value="https://www.sozcu.com.tr/kategori/otomativ/">Otomativ</option>
                </select><br />
                <input type="hidden" class="botCore" value="sozcu" />
    ...
    function list()
    {
        ...
        <div class="bib-list">
            <form id="bibForm" action="javascript:;" method="post">
                ...
                <input type="hidden" name="core" value="sozcu" />
    ...
    function data()
    {
        ...
        preg_match_all('@<div class="listed-img"> <a href="(.*?)"> <img@si', $kaynak, $kLink);
        ?>
        <hr>
        <div class="bib-dataArea">
            ...
            <?php foreach($kLink[1] as $key_link=>$value_link):
                ...
                $makale	 = '@<div class="content-hb" aip-news-article-id="(.*?)">(.*?)<div class="tag-list">@si';
                ...
                preg_match_all('@<meta property="og:description" content="(.*?)"/>@si', $kn, $ozet);
                ...
                preg_match_all('@<a class="related-news-box"(.*?)</span></span>@si', $kn, $related_content);
                $icerik = str_replace($related_content[0], null, $content[2][0]);
