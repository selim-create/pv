    ...
    ?>
      <div class="bib-list">
        ...
        <label>Kaynak Kategori</label><select name="category" class="bib-input cronCat">
          <option value="https://haber.doviz.com/gundem-haberleri">Gündem Haberleri</option>
          <option value="https://haber.doviz.com/doviz-haberleri">Döviz</option>
          <option value="https://haber.doviz.com/kripto-para-haberleri">Kripto Paralar</option>
          <option value="https://haber.doviz.com/altin-ve-degerli-metal-haberleri">Altın</option>
          <option value="https://haber.doviz.com/borsa-haberleri">Borsa</option>
          <option value="https://haber.doviz.com/emtia-haberleri">Emtia</option>
        </select><br />
        <input type="hidden" class="botCore" value="doviz" />
  ...
  function list()
  {
    ?>
      <div class="bib-list">
        ...
        <input type="hidden" name="core" value="doviz" />
...
if(empty($allowed_html))
{
  $allowed_html = "<p><h2><h3><br><strong><b><h4><h5><h6><table><tr><td><th><tbody><img>";
    ...
    preg_match_all('@class="title" href="(.*?)"@si', $kaynak, $kLink);
    ?>
    <hr>
    <div class="bib-dataArea">
      ...
      <?php foreach($kLink[1] as $key_link=>$value_link):
        ...
        preg_match_all('@<meta name="news_keywords" content="(.*?)">@si', $kn, $tags);

        preg_match_all('@<meta name="description" content="(.*?)">@si', $kn, $ozet);
        preg_match_all('@<div class="content">(.*?)<aside class="news-similars">@si', $kn, $content);
      ...
      <div class="bib-data">
        ...
        <div class="left">
          ...
          <label>Etiket</label><input type="text" class="bib-input" name="post_tags" value="<?=$tags[1][0]?>" />
