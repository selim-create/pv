                    ...
                    <div class="mainContentArea">
						...
						<div class="breadcrumb">
							<ul class="block">
								...
								<li><a href="/halka-arz-takvimi/">Halka Arz Takvimi<i>/</i></a></li>
...
<p>Event starts: <?php the_field('halka_arz_tarihi'); ?> <?php the_field('bitis-tarihi'); ?></p>
                      ...
                      <div class="sc-options-right">
                          ...
                          <div class="options-icons">
                              <a href="https://twitter.com/intent/tweet/?url=<?php the_permalink(); ?>" target="_blank"><div class="icon-border twitter">
                                      <i></i>
                                  </div></a>
                          </div>
                          <div class="options-icons">
