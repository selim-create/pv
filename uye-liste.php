...
if(is_user_logged_in())
{
  ...
  $liste_data = get_user_meta($user_data->ID, "uye_liste", true);
      ...
      <div class="uyeProfil">
        <div class="uyeProfilSidebar">
          <ul>
            ...
            <li><a href="<?php bloginfo("home")?>/<?=$bp_options['page_uyelistesi']?>" class="active"><i class="menu-icon liste"></i>Listelerim </a></li>
              ...
              <table class="currencyTable">
                ...
                <tr class="<?=$val?>">
                  ...
                  ?>
                    ...
                    <td style="padding-left: 33px;font-weight: normal;"><?=$currency_data['selling'][$val]?></td>
                    <td style="padding-left: 33px;font-weight: normal;"><span class="<?=$crease_status?> subtract">% <?=$currency_data['change_rate'][$val]?></span></td>
                    <td style="padding-left: 33px;font-weight: normal;"><a href="javascript:;" onclick="listedenCikar('<?=$val?>')"><i class="remove_button"></i></a></td>
                  </tr>
                <?php endforeach; ?>
              </table>
            </div>
