...
if( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public function set_options() {
      ...
      if( wp_verify_nonce( csf_get_var( 'csf_options_nonce' ), 'csf_options_nonce' ) ) {
        ...
        if( empty( $this->notice ) ) {
          $this->notice = esc_html__( 'Kaydedildi.', 'csf' );
        }
    ...
    public function add_admin_footer_text() {
      $default = '<a href="https://birtema.com/" target="_blank">BirTema</a> kullandığınız için teşekkür ederiz.';
      ...
      echo '<div class="csf csf-theme-'. $this->args['theme'] .' csf-options'. $wrapper_class .'" data-slug="'. $this->args['menu_slug'] .'" data-unique="'. $this->unique .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo ( $this->args['show_search'] ) ? '<div class="csf-search"><input type="text" placeholder="'. esc_html__( 'Ara', 'csf' ) .'" /></div>' : '';

            echo '<div class="csf-buttons">';
            echo '<input type="submit" name="'. $this->unique .'[_nonce][save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Kaydet', 'csf' ) .'" data-save="'. esc_html__( 'Kaydediliyor...', 'csf' ) .'">';
            echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Onar', 'csf' ) .'" data-confirm="'. esc_html__( 'Emin misiniz?', 'csf' ) .'">' : '';
            echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button button-secondary csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Reset All', 'csf' ) .'" data-confirm="'. esc_html__( 'Emin misiniz?', 'csf' ) .'">' : '';
            echo '</div>';
        ...
        if( ! empty( $this->args['show_footer'] ) ) {
          ...
          echo '<div class="csf-buttons">';
          echo '<input type="submit" name="csf_transient[save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Kaydet', 'csf' ) .'" data-save="'. esc_html__( 'Kaydediliyor...', 'csf' ) .'">';
          echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Onar', 'csf' ) .'" data-confirm="'. esc_html__( 'Emin misiniz?', 'csf' ) .'">' : '';
          echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button button-secondary csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Reset All', 'csf' ) .'" data-confirm="'. esc_html__( 'Emin misiniz?', 'csf' ) .'">' : '';
          echo '</div>';
