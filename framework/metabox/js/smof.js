...
jQuery(document).ready(function($){
	...
	$('#of_backup_button').live('click', function(){
		...
		var answer = confirm("Tamam'a basarak şu andaki kayıtlı ayarlarınızı yedekleyebilirsiniz. Dikkat, eğer daha önceden kayıtlı yedeğiniz varsa onun üstüne yazılacaktır!")
	...
	$('#of_restore_button').live('click', function(){
		...
		var answer = confirm("Tamam'a basarak yedekteki ayarınılarınızı geri yükleyebilirsiniz.")
	...
	$('#of_import_button').live('click', function(){
		...
		var answer = confirm("Tamam'a basarak ayarlarınızı içeri aktarabilirsiniz.")
	...
	$('#of_reset').click(function() {
		...
		//confirm reset
		var answer = confirm("Tamam'a basarak ayarlarınızı sıfırlayabilirsiniz. Dikkat, EccePanelde kayıtlı tüm verileriniz silinecektir!");
