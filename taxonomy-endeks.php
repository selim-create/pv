...
echo '<article class="index-list">';
                      ...
                      if ($baslangic_tarihi && $bitis_tarihi && $baslangic_tarihi <= $bugun2 && $bitis_tarihi >= $bugun2) {
                        echo '<div class="il-tt">';
                          echo '<div class="circle pulse"></div> Talep toplanıyor ';
                        echo '</div>';
                      }
                      if ($bitis_tarihi && $bitis_tarihi < $bugun2) {
                        echo '<i class="fa-solid fa-check snc-badge"></i>';
                      }
                      if (!empty($hisse['arz-yurt-ici-bireysel-kisi'])) {
                        echo '<i class="fa-solid fa-check-double snc-badge"></i>';
                      }
                      ...
                      if ($hisse['on-onay']) {
                            $on_onay = '<i class="fa-solid fa-list-check snc-badge"></i>';
                        }
                      ...
                      echo '<div class="il-content">';
                        if (!empty($hisse['bist-islem-tarihi'])) {
                          if (!empty($hisse['bist-kodu'])) {
                              ...
                              echo '<span class="il-bist-kod">' . $hisse['bist-kodu'] . ' ' . $on_onay . ' <i class="fa-solid fa-arrow-trend-up snc-badge"></i></span>';
                              } else {
